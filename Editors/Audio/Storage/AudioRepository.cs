...
namespace Editors.Audio.Storage
{
    ...
    {
        public Dictionary<uint, Dictionary<uint, List<HircItem>>> HircLookupByLanguageIDByID { get; }
        public Dictionary<uint, Dictionary<uint, List<ICAkSound>>> SoundHircLookupByLanguageIDBySourceID { get; }
        public Dictionary<uint, Dictionary<uint, List<DidxAudio>>> DidxAudioLookupByLanguageIDByID { get; }
        public Dictionary<uint, List<HircItem>> HircLookupByID { get; }
        public Dictionary<uint, List<DidxAudio>> DidxAudioLookupByID { get; }
        public Dictionary<string, PackFile> BnkPackFileLookupByName { get; }
        public Dictionary<uint, string> NameLookupByID { get; }
        public Dictionary<string, List<string>> StateGroupsLookupByDialogueEvent { get; }
        public Dictionary<string, Dictionary<string, string>> QualifiedStateGroupLookupByStateGroupByDialogueEvent { get; }
        public Dictionary<string, List<string>> StatesLookupByStateGroup { get; }
        public Dictionary<string, Dictionary<uint, string>> StatesLookupByStateGroupByStateID { get; }
        ...
        public string GetNameFromID(uint value);
