...
{
    public interface IRemoveFromAudioProjectUICommand : IUiCommand
    {
        NodeType NodeType { get; }
        void Execute(DataRow row);
    }

    public class RemoveFromAudioProjectCommandFactory : IUiCommand
    {
        private readonly Dictionary<NodeType, IRemoveFromAudioProjectUICommand> _uiCommands;

        public RemoveFromAudioProjectCommandFactory(IEnumerable<IRemoveFromAudioProjectUICommand> nodeTypes)
        {
