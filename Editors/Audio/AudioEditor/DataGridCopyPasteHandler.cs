...
{
    public class DataGridCopyPasteHandler
    {
        public static void CopyDialogueEventRows(AudioEditorViewModel audioEditorViewModel, IAudioProjectService audioProjectService)
        {
            ...
            SetIsPasteEnabled(audioEditorViewModel, audioProjectService);
        }

        public static void PasteDialogueEventRows(AudioEditorViewModel audioEditorViewModel, IAudioProjectService audioProjectService, DialogueEvent selectedDalogueEvent)
        {
            foreach (var copiedDataGridRow in audioEditorViewModel.CopiedDataGridRows)
            {
                ...
                AddDataGridRowToDialogueEvent(copiedDataGridRow, selectedDalogueEvent, audioProjectService.DialogueEventsWithStateGroupsWithQualifiersAndStateGroupsRepository);
            }

            SetIsPasteEnabled(audioEditorViewModel, audioProjectService);
        }

        public static void SetIsPasteEnabled(AudioEditorViewModel audioEditorViewModel, IAudioProjectService audioProjectService)
        {
            ...
            if (audioEditorViewModel._selectedAudioProjectTreeItem is DialogueEvent selectedDialogueEvent)
            {
                ...
                var stateGroupsWithQualifiers = audioProjectService.DialogueEventsWithStateGroupsWithQualifiersAndStateGroupsRepository[selectedDialogueEvent.Name];
