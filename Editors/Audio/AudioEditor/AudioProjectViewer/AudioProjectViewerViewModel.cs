    ...
    public partial class AudioProjectViewerViewModel : ObservableObject
    {
        ...
        private void RemoveData(NodeType nodeType)
        {
            ...
            foreach (var row in selectedRows)
                _uiCommandFactory.Create<RemoveFromAudioProjectCommandFactory>().Execute(nodeType, row);
        ...
        public void PasteDialogueEventRows()
        {
            foreach (var copiedRow in _copiedRows)           
            {
                ...
                _uiCommandFactory.Create<AddToAudioProjectCommandFactory>().Execute(NodeType.DialogueEvent, pastedRow);
            }
