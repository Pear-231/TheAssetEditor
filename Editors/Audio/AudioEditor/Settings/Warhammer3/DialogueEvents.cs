...
using static Editors.Audio.AudioEditor.Settings.Warhammer3.DialogueEvents.DialogueEventPreset;
using static Editors.Audio.AudioEditor.Settings.Warhammer3.SoundBanks.SoundBank;
...
namespace Editors.Audio.AudioEditor.Settings.Warhammer3
{
    public class DialogueEvents
    {
        ...
        public static List<(string Name, SoundBanks.SoundBank SoundBank, DialogueEventPreset[] DialogueEventPreset, bool Recommended)> DialogueEventData { get; } =
        [
            // Frontend VO
