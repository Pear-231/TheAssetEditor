    ...
    public class EditorDialogueEventDataGridService : IDataGridService
    {
        ...
        public void SetInitialDataGridData(DataTable table)
        {
            ...
            foreach (var stateGroupWithQualifier in stateGroupsWithQualifiers)
            {
                ...
                var stateGroup = AudioProjectHelpers.GetStateGroupFromStateGroupWithQualifier(_audioRepository, dialogueEvent.Name, DataGridHelpers.DeduplicateUnderscores(columnName));
