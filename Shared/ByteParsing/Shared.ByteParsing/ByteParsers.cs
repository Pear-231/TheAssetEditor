...
namespace Shared.ByteParsing
{
    public static class ByteParsers
    {
        ...
        public static OptionalIntParser OptionalInt32 { get; set; } = new OptionalIntParser();
        public static ColourRgbParser ColourRgb { get; set; } = new ColourRgbParser();
        ...
        public static IByteParser[] GetAllParsers() { return [Byte, Int32, Int64, UInt32, Single, Double, Float16, Short, UShort, Bool, OptionalInt32, ColourRgb, OptString, String, OptStringAscii, StringAscii, FixedAciiString1, FixedString1]; }
