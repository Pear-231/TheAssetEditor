...
{
    // WEM retains the standard RIFF sampler loop. Its end point is inclusive in the file and is
    // normalised to an exclusive frame here, matching spans and the engine playhead.
