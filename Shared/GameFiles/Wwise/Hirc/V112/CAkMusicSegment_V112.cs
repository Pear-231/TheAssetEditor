...
namespace Shared.GameFormats.Wwise.Hirc.V112
{
    public sealed class CAkMusicSegment_V112 : HircItem
    {
        ...
        protected override void ReadData(ByteChunk chunk)
        {
            ...
            {
                var musicMarker = new MusicMarker_V112();
                musicMarker.ReadData(chunk);
                Markers.Add(musicMarker);
            }
        }
        ...
        public sealed class MusicMarker_V112
        {
            ...
            public void ReadData(ByteChunk chunk)
            {
                ...
                Name = nameLength == 0 ? string.Empty : Encoding.UTF8.GetString(chunk.ReadBytes(checked((int)nameLength)));
            }
        }
    }
}
