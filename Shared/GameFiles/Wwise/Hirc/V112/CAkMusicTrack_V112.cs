...
namespace Shared.GameFormats.Wwise.Hirc.V112
{
    public sealed class CAkMusicTrack_V112 : HircItem, ICAkMusicTrack
    {
        ...
        protected override void ReadData(ByteChunk chunk)
        {
            ...
            {
                var akBankSourceData = new AkBankSourceData_V112();
                akBankSourceData.ReadData(chunk);
                Sources.Add(akBankSourceData);
            }

            var playlistCount = chunk.ReadUInt32();
            for (var index = 0; index < playlistCount; index++)
            {
                var trackSourceInfo = new TrackSourceInfo_V112();
                trackSourceInfo.ReadData(chunk);
                Playlist.Add(trackSourceInfo);
            }
            if (playlistCount > 0)
            ...
            {
                var clipAutomation = new ClipAutomation_V112();
                clipAutomation.ReadData(chunk);
                ClipAutomation.Add(clipAutomation);
            }
        ...
        public sealed class TrackSourceInfo_V112
        {
            ...
            public void ReadData(ByteChunk chunk)
            {
                ...
                SourceDuration = chunk.ReadDouble();
            }
        }
        ...
        public sealed class TrackSwitchParams_V112
        {
            ...
            public void ReadData(ByteChunk chunk)
            {
                ...
                var count = chunk.ReadUInt32();
                for (var index = 0; index < count; index++)
                    Associations.Add(chunk.ReadUInt32());
            }
        }
