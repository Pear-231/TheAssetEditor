...
namespace Shared.GameFormats.Wwise.Hirc.V136.Shared
{
    public class StateChunk_V136
    {
        ...
        public void ReadData(ByteChunk chunk)
        {
            ...
            {
                var akStatePropertyInfo = new AkStatePropertyInfo_V136();
                akStatePropertyInfo.ReadData(chunk);
                StateProps.Add(akStatePropertyInfo);
            }

            NumStateGroups = chunk.ReadByte();
            for (var i = 0; i < NumStateGroups; i++)
            {
                var akStateGroupChunk = new AkStateGroupChunk_V136();
